...
public class DTDecision : IDTNode {
    ...
    public DTDecision(Func<object> nearest)
    {
...
public class DTAction : IDTNode {
    ...
    private Action followNearest;

    public DTAction(DTCall callee) {
		Action = callee;	
	}

    public DTAction(Action followNearest)
    {
        this.followNearest = followNearest;
    }
